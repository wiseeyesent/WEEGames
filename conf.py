...
BLOG_TITLE = "WEE Games"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "https://nikola.games.wiseeyesent.com/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "https://nikola.games.wiseeyesent.com/"
BLOG_EMAIL = "admin@wiseeyesent.com"
BLOG_DESCRIPTION = "Games & More by WiseEyes Enterprise"  # (translatable)
